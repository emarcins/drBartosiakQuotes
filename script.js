...
const mindArr = [
  ...
  "Istotą jest asymetryczne wykorzystywanie przewagi na różnych szczeblach drabiny eskalacyjnej.",
  ...
  "Szykowanie wojska następuje w kontekście wymiany kinetycznej z dominacją eskalacyjną.",
  ...
  "Afgańczycy tak jak Wietnamczycy kiedyś, zdominowali pętlę decyzyjną.",
  ...
  "Ruch ludzi to klasyczny przepływ strategiczny.",
  "Prawdziwy system odporności państwa dotyczy manipulacji przepływami strategicznymi.",
  "W domenie kosmicznej są oczywiście pewne dystraktory, jak chociażby czasami chmury.",
  "Kosmos będzie rozstrzygający w walce o przepływy strategiczne i panowanie na Ziemi .",
  ...
  "Nie da się przyjść z pomocą państwom bałtyckim bez poszerzenia podstawy operacyjnej.",
  ...
  "Rewizja doktryny Giedroycia i Miroszewskiego jest potrzebna od zaraz.",
